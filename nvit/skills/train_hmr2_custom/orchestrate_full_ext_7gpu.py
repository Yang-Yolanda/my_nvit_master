...
class HMR2FullExtOrchestrator(SkillBase):
    def __init__(self, gpu="0,1,2,3,4,5,6,7", output_dir="output/hmr2_full_ext_training"):
    ...
    def run_training(self, epochs, batch_size, lr, dry_run=False):
        ...
        cmd = [
            ...
            "++trainer.devices=8", # Explicitly request 8 GPUs
            ...
            "++GENERAL.task_name=Run11_FullExt_8GPU_Split8_11_Safe"
        ]
