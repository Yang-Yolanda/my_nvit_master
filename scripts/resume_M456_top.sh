...
train_method 5 "M4" "Prior-as-Loss" "++MODEL.BACKBONE.USE_ADAPTIVE_NVIT=False ++TRAIN.LOSS_WEIGHTS.HEATMAP=2.0"
train_method 6 "M5" "Hard-Adjacency-Only" "++MODEL.BACKBONE.USE_ADAPTIVE_NVIT=False ++MASK_CONFIG.mode=hard ++MASK_CONFIG.mask_layers=${ALL_LAYERS} ++MASK_CONFIG.domain=skeleton"
train_method 7 "M6" "Soft-Distance-Bias-Only" "++MODEL.BACKBONE.USE_ADAPTIVE_NVIT=False ++MASK_CONFIG.mode=soft ++MASK_CONFIG.mask_layers=${ALL_LAYERS} ++MASK_CONFIG.domain=skeleton"
